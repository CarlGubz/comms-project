...
CREATE TABLE `table_the_iot_projects` (
  ...
  `patients_id` varchar(100) NOT NULL,
...
INSERT INTO `table_the_iot_projects` (`hospitals_name`,`dea`, `doctors_name`, `patients_id`, `name`,`gender`,  `age`,`prescription`,`existing_medical_condition`) VALUES
